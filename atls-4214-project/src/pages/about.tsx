                    ...
                    <Grid item xs={6} md={5}>
                        ...
                        >
                            ...
                            <Typography
                                ...
                                textAlign='left'
                            >
                                Data is collected from the FBI's Crime Data Explorer, which hosts data from the National Incident-Based Reporting System (NBIRS).  The data used spans the years 2016-2021 
